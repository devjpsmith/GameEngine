...
public class TiledMap implements IDrawable{
	...
	public TiledMap(){
		...
		tileArray = new int[]{44,44,44,44,44,44,44,44,66,66,66,66,66,66,66,66,66,66,66,66,66,66,66,66,66,66,66,66,66,66,66,66,
				...
				44,44,66,66,66,66,66,66,66,66,66,66,66,66,66,66,66,220,197,197,198,66,66,66,66,66,66,66,66,66,66,66,
				44,66,66,66,66,66,66,66,66,66,66,66,66,66,66,66,66,196,197,197,198,66,66,66,66,66,66,66,66,66,66,66,
	...
	public void draw(Graphics g) {
		...
		for(int i = 1; i < tileArray.length; i++){
	        ...
	        drawTile(g, pixelPosX, pixelPosY, tileArray[i]);
	...
	public void drawTile(Graphics g, int x, int y, int gid){
		int sourceX = ((gid % sourceWidthInTiles) * tileSize) - tileSize;
		int sourceY = (Math.floorDiv(gid, sourceWidthInTiles)) * tileSize;
